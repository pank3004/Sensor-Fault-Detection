...
class TrainingPipeline: 
    ...
    def start_model_training(self,train_arr, test_arr): 
        try: 
            ...
            trained_model_path=model_trainer.initiate_model_trainer(train_array=train_arr, test_array=test_arr)
    ...
    def run_pipeline(self): 
        try: 
            ...
            trained_model_file_path=self.start_model_training(train_arr=train_arr, test_arr=test_arr)
